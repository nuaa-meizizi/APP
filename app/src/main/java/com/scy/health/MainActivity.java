...
import com.scy.health.control.InitConfig;
import com.scy.health.listener.UiMessageListener;
import com.scy.health.util.AutoCheck;
...
public class MainActivity extends AppCompatActivity implements EventListener {
    ...
    protected String appId = "11041790";
    protected String appKey = "H6gkMLq2UCcKLsAbRMMxnnaF";
    protected String secretKey = "b99dc1dd6faf38ed08821a65f241d9df";
    ...
    private static final String TEXT = "他调用了IsValidClassName方法，注意第三个参数是'/'，这是类名的分隔符，而我这里调用FindClass时类名是使用了'.'分隔，改成'/'，问题就解决了。";
